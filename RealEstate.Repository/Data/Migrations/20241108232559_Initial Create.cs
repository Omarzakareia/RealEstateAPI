        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProjectTitle = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ProjectName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    DeveloperId = table.Column<int>(type: "int", nullable: true),
                    ProjectArea = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    UnitAreas = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    UnitTypes = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ...
                    PricePerSquareMeter = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    PricePerMeter = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    About = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PaymentMethods = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectHighlights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectHighlights_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CallRequests_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CallRequests_Properties_PropertyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CallRequests_ProjectId",
                table: "CallRequests",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_CallRequests_PropertyId",
                table: "CallRequests",
                column: "PropertyId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectHighlights_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_DeveloperId",
                table: "Properties",
                column: "DeveloperId");
